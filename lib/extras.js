(function () {
  const messages = [
    ...
    {
      text: "Eğer biri sana bir TinDay özelliğini açmak için bir şey kopyalayıp buraya yapıştırmanı söylediyse, saldırı içindir, yapıştırmadan önce lütfen bizimle iletişime geçin.",
